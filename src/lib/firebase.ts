...
import { getFirestore, doc, onSnapshot, collection, query, where, getDocs, Timestamp } from "firebase/firestore";
...
export { app, auth, db, doc, onSnapshot, collection, query, where, getDocs, Timestamp, processOrderDoc };
