...
import { getFirestore, doc, onSnapshot, collection, query, where, getDocs, getDoc, Timestamp } from "firebase/firestore";
import { processOrderDoc } from './data';
...
export { app, auth, db, doc, onSnapshot, collection, query, where, getDocs, getDoc, Timestamp, processOrderDoc };
